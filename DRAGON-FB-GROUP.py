...
print "   /$$$$$$$          /$$$$$$$$ /$$$$$$$           /$$$$$$  /$$$$$$$   /$$$$$$  /$$   /$$ /$$$$$$$ " % (W, N)
print "  | $$__  $$        | $$_____/| $$__  $$         /$$__  $$| $$__  $$ /$$__  $$| $$  | $$| $$__  $$ " % (W, N)
print "  | $$  \ $$        | $$      | $$  \ $$        | $$  \__/| $$  \ $$| $$  \ $$| $$  | $$| $$  \ $$ "% (W, B, R, N)
print "  | $$  | $$ /$$$$$$| $$$$$   | $$$$$$$  /$$$$$$| $$ /$$$$| $$$$$$$/| $$  | $$| $$  | $$| $$$$$$$/ "% (C, B, C, N)
print "  | $$  | $$|______/| $$__/   | $$__  $$|______/| $$|_  $$| $$__  $$| $$  | $$| $$  | $$| $$____/ "% (W, B, R, N)
print "  | $$  | $$        | $$      | $$  \ $$        | $$  \ $$| $$  \ $$| $$  | $$| $$  | $$| $$      "% (W, B, R, N)
print "  | $$$$$$$/        | $$      | $$$$$$$/        |  $$$$$$/| $$  | $$|  $$$$$$/|  $$$$$$/| $$      "% (C, B, C, N)
print "  |_______/         |__/      |_______/          \______/ |__/  |__/ \______/  \______/ |__/      "% (W, B, R, N)
                                                                                                
print " %s============================%s|%s======================%s " % (C, B, C, N)

print " %sD-FB%s Group%s Hack %s3-01-2021%s (0:55)%s" % (W, B, R, C, Y, N)

print " %sDevelop by: %sDRAGON HELL %s$$$%s DRAGON Hack%s" % (W, R, W, Y, N)
...
print " %sThis Tool is for educational purpose only%s" % (C, N)
